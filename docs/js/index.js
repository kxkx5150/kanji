...
function showMondai(){
    ...
    k1.innerHTML = "<span class='toi_jyomi'>"+Q[MondaiIndex].Ans[0].replace(/\,/g,",\u00a0")+"</span><span class='toi_vyomi'>"+Q[MondaiIndex].V[0]+"</span>";
    k2.innerHTML = "<span class='toi_jyomi'>"+Q[MondaiIndex].Ans[1]+"</span><span class='toi_vyomi'>"+Q[MondaiIndex].V[1]+"</span>"+"</span>";
    k3.innerHTML = "<span class='toi_jyomi'>"+Q[MondaiIndex].Ans[2]+"</span><span class='toi_vyomi'>"+Q[MondaiIndex].V[2]+"</span>"+"</span>";
    k4.innerHTML = "<span class='toi_jyomi'>"+Q[MondaiIndex].Ans[3]+"</span><span class='toi_vyomi'>"+Q[MondaiIndex].V[3]+"</span>"+"</span>";
...
function loadSVG(ucode){
    ...
    xhr.open("GET", "https://kxkx5150.github.io/Joyo_Kanji_Viet/kanjivg/0"+ucode+".svg" , true);
...
function loadREI(kanji){
    var xhr = new XMLHttpRequest();
    xhr.open("GET", "https://kxkx5150.github.io/Joyo_kanji_Eng/rei/"+kanji+".txt" , true);
    xhr.onreadystatechange = function() {
        if (xhr.readyState == 4){
            if(xhr.status == 200) {
                var restxt = xhr.responseText;
